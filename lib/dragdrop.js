...
var dragdrop = {
  ...
  droponStatus: function(e) {
    ...
    var ticketStatus = this.$(e.target).closest('.ticket-status'),
        ...
        status = draggedEl.closest('.ticket-status').data('index'),
    ...
    this.trigger('transitionTicket', { id: id, newStatus: newStatus, status: status });
  },
  ...
  droponTicket: function(e) {
    ...
    this.trigger('transitionTicket', { id: id, newStatus: newStatus, nextId: dropId, status: status });
  },
